...
- Keep v1.3.5 available through judging. It fixes public run-summary presentation; broader web and AgentCore behavior was proven in v1.3.2 at commit `90b68385`, where all nine protected production probes passed.
