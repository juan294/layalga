...
Updated September 11, 2026. This is the current roadmap after the v1.3.2 production release. Dated research and earlier plans record the decisions that led here; they are not a current backlog. The released product, submission work, guest-email activation, and human evidence remain distinct.
...
- Keep v1.3.2 available through judging and use the [release playbook](release/e2e-pro-playbook.md) if a new candidate is required. The current web and AgentCore production identities are bound to commit `90b68385`; all nine protected production probes passed.
