...
2. Follow the source-and-test map below. The v1.3.11 release records privacy-minimized host and guest demo entry so review activity can be checked without relying on short-lived logs. It retains the safe run-result presentation from v1.3.10. Broader production evidence remains pinned to the exact v1.3.2 production gate at commit `90b68385a590144d6d44cd7dd41298180b2d182c`.
...
| Presentation               | One coherent routine → exception → follow-through story                                                  | [Public 3:11 demo video](https://youtu.be/-D3GvJ88-40), [video script](video-script.md), this walkthrough, and [system guide](system-guide.md). The Devpost entry is submitted with all five steps complete.                                                                                                                                                                                                                                                                                                                                |

## Walk through the synthetic product

Use the [live site](https://layalga.thecreativetoken.com) for the judged demonstration. The v1.3.2 protected run reported commit `90b68385a590144d6d44cd7dd41298180b2d182c`, healthy configuration, and no stale or retrying work; v1.3.11 adds durable review-access visibility and retains the v1.3.10 presentation fixes. A local target remains available for source reproduction, with its scripted-model limits stated separately.
...
The deadline is **14 September 2026, 17:00 PDT**; judging runs through 8 October. The official video maximum is five minutes. The published video is 3 minutes 11 seconds. These dates and requirements come from the [official rules](https://agentsforhumans.devpost.com/rules), checked 14 September 2026.

Three supporting articles are published on AWS Builder Center: [deterministic household policy](https://builder.aws.com/content/3JDQAfyHGB6qjJ0jAxwcnaCdRUk/agents-for-humans-deterministic-household-policy-under-a-strands-agent), [durable interrupts](https://builder.aws.com/content/3JDQsaSl4Yucs12mbJpXOyRCj5b/agents-for-humans-durable-interrupts-for-household-decisions), and [proactive follow-through](https://builder.aws.com/content/3JDR9dE9hJBcB4SItqBUl0GqL01/agents-for-humans-testing-proactive-follow-through-with-an-honest-clock). The rules offer 0.2 bonus points per eligible public post, up to 0.6. The Devpost AWS Builder ID, Everyday Agents track, repository, two architecture diagrams, live demo, video, and article fields are populated, and the entry is submitted. Human research, guest SES permission, and real-recipient verification remain separate work; see [guest email readiness](../release/guest-email-readiness.md).
