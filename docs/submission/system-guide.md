...
The [video script](video-script.md) presents this story against the verified v1.3.2 production target. Recording/upload, optional Builder publication, final entry, guest-email activation, and participant research remain distinct actions.
