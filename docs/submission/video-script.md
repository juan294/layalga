...
- Record `https://layalga.thecreativetoken.com` only after `/api/health` reports `status: ok`, identifies the v1.3.10 release commit, and reports no stale or retrying work.
