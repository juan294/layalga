...
3. Apply all candidate migrations in order, including invitation access, cancellation, notes and policy prerequisites (`20260905000100` through `20260905000400`), then the guest-delivery migrations (`20260905000500_guest_delivery.sql`, `20260905000600_guest_delivery_attempts.sql` and `20260905000700_guest_delivery_recovery_indexes.sql`) through the administrative database path before deploying the matching web code. Preserve separate non-owner web and agent database credentials.
